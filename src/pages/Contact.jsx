      ...
      <div className="max-w-6xl mx-auto">
        ...
        <ScrollReveal>
          ...
          <p className="section-sub">
            Interested in bulk pricing, custom orders, or product enquiries? We'd love to hear from you.
          </p>
        </ScrollReveal>
              ...
              <GlassCard className="p-6">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {['Quality Assured', 'Factory Direct', 'ISO Certified', 'Monthly Shipments'].map((tag) => (
                    <span key={tag} className="text-xs px-3 py-1 rounded-full bg-sky-500/15 text-sky-400 border border-sky-500/25">
                      {tag}
                    </span>
                  ))}
                </div>
            ...
            <ScrollReveal direction="right" delay={0.2}>
              <GlassCard className="overflow-hidden">
                <div className="relative h-48">
                  <img
                    src="https://images.unsplash.com/photo-1580674684081-7617fbf3d745?auto=format&fit=crop&w=600&h=300&q=80"
              ...
              <GlassCard className="p-8">
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} noValidate>
                    ...
                    <button
                      type="submit"
                      className="glow-btn w-full py-4 rounded-xl font-bold text-white bg-gradient-to-r from-sky-500 to-blue-600 text-base"
                    >
                      Send Message →
                    </button>
                  </form>
