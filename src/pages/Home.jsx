...
const features = [
  {
    ...
    desc: 'We source directly from top Chinese manufacturers, bypassing middlemen to deliver superior quality at competitive prices.',
  },
  {
    icon: '✅',
    title: 'Quality Assured',
    desc: 'Every product undergoes strict quality inspection before shipping, ensuring only the finest accessories reach you.',
  },
  {
    icon: '🛋️',
    title: 'Premium Accessories',
    desc: 'From elegant handles to precision hinges, our curated collection elevates every piece of furniture.',
  },
]
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center min-h-screen py-24">
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            <Link
              to="/products"
              className="glow-btn px-8 py-4 rounded-2xl font-bold text-white bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-600 text-base"
              data-hover
            >
              Explore Products →
            </Link>
            <Link
              to="/contact"
              className="px-8 py-4 rounded-2xl font-bold glass border border-white/12 text-white hover:border-sky-500/40 hover:bg-white/6 transition-all duration-300 text-base"
              data-hover
            >
              Get a Quote
            </Link>
      ...
      <section className="py-28 px-6 relative">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <ScrollReveal className="text-center mt-14">
            <Link
              to="/products"
              className="glow-btn inline-block px-10 py-4 rounded-2xl font-bold text-white bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-600"
              data-hover
            >
              View All Products →
            </Link>
        ...
        <ScrollReveal>
          <div className="max-w-4xl mx-auto text-center neon-card p-14 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Link
                to="/contact"
                className="glow-btn inline-block px-12 py-5 rounded-2xl font-bold text-white text-lg bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-600"
                data-hover
              >
                Contact Us Today →
              </Link>
