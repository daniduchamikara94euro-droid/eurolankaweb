...
export default function ProductCard({ product, delay = 0, onClick }) {
  ...
  return (
    <motion.div ref={cardRef} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} onClick={onClick}
      className="tilt-card glass-card overflow-hidden group cursor-pointer" style={{ transition: 'transform 0.15s ease-out' }}
