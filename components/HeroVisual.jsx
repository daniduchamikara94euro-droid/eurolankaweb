...
function FloatCard({ children, delay = 0, className = '', style = {} }) {
  return (
    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay }} className={className} style={style}>
...
function Chip({ emoji, label, delay }) {
  return (
    <FloatCard delay={delay}>
      <div className="flex items-center gap-2 px-3 py-2 rounded-xl border text-xs font-semibold text-white backdrop-blur-xl"
        style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', boxShadow: '0 4px 20px rgba(0,0,0,0.4)', whiteSpace: 'nowrap' }}>
...
function StatPill({ value, label, color, delay }) {
  return (
    <FloatCard delay={delay}>
      <div className="px-4 py-3 rounded-2xl backdrop-blur-xl text-center"
        style={{ background: 'rgba(255,255,255,0.05)', border: `1px solid ${color}40`, boxShadow: `0 0 20px ${color}20, 0 8px 30px rgba(0,0,0,0.5)` }}>
  ...
  return (
    <div className="relative w-full h-full select-none" style={{ perspective: '1000px' }}>
      <div className="absolute rounded-full pointer-events-none"
        style={{ width: '340px', height: '340px', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', background: 'radial-gradient(circle, rgba(14,165,233,0.18) 0%, rgba(129,140,248,0.1) 50%, transparent 70%)', filter: 'blur(40px)' }} />
      ...
      <div className="absolute -top-2 right-0"><StatPill value="500+" label="Products" color="#0ea5e9" delay={0.6} /></div>
      <div className="absolute top-[38%] -right-2"><StatPill value="1200+" label="Clients" color="#818cf8" delay={0.75} /></div>
      <div className="absolute top-[58%] -left-2"><Chip emoji="🔩" label="Hinges" delay={0.5} /></div>
      <div className="absolute bottom-[6%] right-0"><Chip emoji="✨" label="Bar Pulls" delay={0.65} /></div>

      <FloatCard delay={0.8} className="absolute" style={{ top: '72%', left: '-4px' }}>
        <div className="flex items-center gap-2 px-3 py-2 rounded-xl backdrop-blur-xl"
          style={{ background: 'rgba(16,185,129,0.1)', border: '1px solid rgba(16,185,129,0.3)', boxShadow: '0 0 20px rgba(16,185,129,0.15)' }}>
